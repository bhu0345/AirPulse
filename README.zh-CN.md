...
| 可预期？ | 否 | 是 — 固定折点，心里有数 |
| 噪音体验 | 负载下突然起飞 | 随温度渐变 |
| 安全网 | 仅系统 | Smart mode **再加** 安静/均衡拦截与转速地板 |
...
**日常建议直接用 AirPulse Smart mode**：写代码、剪视频、轻度游戏时不用盯着滑杆，又比干等系统突然拉满更从容。需要时仍可一键切安静 / 均衡 / 强冷 / 自动。
...
3. 启动（菜单栏风扇图标）
4. 点一次 **启用风扇控制**（管理员密码）
5. 日常优先选 **AirPulse Smart mode**，需要时再切 Auto / Quiet / Balanced / Cool
...
- 预设：**自动 · 安静 · 均衡 · 强冷 · 智能**（**AirPulse Smart mode**）
- 可解除联动，分别控制左右风扇
- 登录时打开 + 记住上次预设 / 转速
- 默认英语，应用内 **English / 中文**
